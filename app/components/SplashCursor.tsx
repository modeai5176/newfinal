...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function optimizedUpdateFrame() {
      ...
      step(dt)
      render(null)
      animationFrameId = requestAnimationFrame(optimizedUpdateFrame)
    }
  ...
  `
    ...
    document.body.addEventListener("mousemove", function handleFirstMouseMove(e: any) {
      const pointer = pointers[0]
      const posX = scaleByPixelRatio(e.clientX)
      const posY = scaleByPixelRatio(e.clientY)
      const color = generateColor()
    ...
    document.body.addEventListener("touchstart", function handleFirstTouchStart(e: any) {
